...
function generatePassword(){
  ...
  var length = prompt("how long of a password do you want")
  ...
  if(length < 8 ){
alert("your password need to contain at least 8 characters")
  }
  else if(length > 128){
    alert("your password should not contain more than 128")
  }
